#@UI All Scenario, Scenario Outline and Examples will inherit the Feature tags
  #Tags placed above a Scenario Outline are automatically inherited by its Examples
